...
- `alert_events`: reserved for internal watchlist/alert generation; no external notification is implied.
...
The current vertical slice stores normalized points for correctness and charting. Before production scale-up:
